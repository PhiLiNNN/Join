...
function createContactContainer(oneContact) {
  return `
        <div class="oneContactContainer" id="contact-${
          oneContact.id
        }" onclick="openContactScreenDesktop('${oneContact.id}')" data-contact-id="${
    oneContact.id
  }">
            <div>                
  ...
  content.innerHTML = /*html*/ `
      ...
      <div id="contactsContentRightSideContactDataContainerID">
        ...
        <div class="openContactEmailLinkDesktopContainer">
          <a class="openContactEmailLinkDesktop" href="mailto:${selectedContact.email}">${
...
function singleMemberToHTMLOpenContactDesktop(member, index) {
  ...
  return `
        <div class="openContactUserImgDesktop" style="background-color: ${
          member.colorCode
