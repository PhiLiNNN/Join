...
function updateContactsByFirstLetter(contactsByFirstLetter, firstLetter, oneContact) {
  ...
  contactsByFirstLetter[firstLetter]
    ...
    .appendChild(oneContactContainer);
}
...
function createOneContactContainer(oneContact) {
  ...
  const iconHtml = renderSingleMemberToHTMLMobile(
    oneContact,
    oneContact.colorCode,
    oneContact.textColorCode
  );
  container.innerHTML = `
...
function generateUniqueID() {
  ...
  do {
    ...
    usersArray.some((user) => user.contacts && user.contacts.some((contact) => contact.id === id))
  );
  return id;
}
...
function createContactOverlayContent(selectedContact) {
  return `
    ...
    <div class="openContactContainerFooter">
        ...
        <a class="openContactEmailLink" href="mailto:${selectedContact.email}">${
    ...
    <div class="dropdown-container" id="contactOptionsDropdownContainer">
        ...
        <div class="dropdown-menu" id="contactOptionsDropdown">
            <div class="dropdown-option" data-value="edit" onclick="editContactOverlayMobile('${
              selectedContact.id
            }')">
    ...
    <form id="editcontactFormMobileID" onsubmit="updateContactMobile(${selectedContact.id})">
      <div class="addContactContainerFooter">
        ...
        <div>
          ...
          <img class="createContactButtonImg" src="./assets/img/contacts/editContactSaveButtonImg.svg" alt="" onclick="updateContactMobile('${
            selectedContact.id
          }')">
        </div>
      </div>
