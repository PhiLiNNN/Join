...
function templateCardInfoHTML(idx, bgColor, prio, date) {
  ...
  return /*html*/ `
    <div class="card-info-wrapper" >
        <div id="card-info-section-id" class="card-info-section" onclick="stopPropagation(event)">
            <div id="close-board-info-at-id" class="close-board-info-at" onclick="closeCardInfo()">
            ...
            <div id="board-info-menu-container-id" class="board-info-menu-container">
